<template>
  <div class="home-book">
    ...
    <div class="home-book-info">
      ...
      <br>
      <button v-if="!isEvaluated()" type="button" class="btn btn-primary" v-bind:data-bs-target="'#modalEvaluate'+id" data-bs-toggle="modal" @click="evaluateBook(id)">Avaliar o livro</button>
    </div>
  </div>
  ...
  data() {
    return {
      ...
      book:{
        ...
        year: 2015,
        id:0,
        evaluations:[{info: "Muito mal escrito!",stars: 2},{info: "Bom pra passar o tempo, mas nada impressionante",stars: 3},{info: "Genial",stars: 4},{info: "Muito mal escrito!",stars: 2},{info: "Muito mal escrito!",stars: 2}]
      },
    };
  },
};
